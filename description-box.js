...
render() {
    ...
    //so that common styles cud be applied
   ...
   return (
    ...
    //total3 views/div are there,this is maindiv above those 3 divs
      <View style={{
        transform: [

            //posn below so that it is below l.o.v of planets 
          {translate: [0, -3, 0]},
          {rotateY: -90}
        ],
        //for child div
        ...
        {/* //1st div for planets */}
        {/* similar to main page,just rotate about y axis ,saturn kliyerotte about x too*/}
     	<View>
        ...
        {/* //contains 8 buttons for planets */}
