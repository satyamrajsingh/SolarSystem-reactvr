...
import Descriptions from './description-box';
    ...
    return (
      <View>
        ...
        <PointLight intensity={1} style ={{color: 'white', transform: [{translate: [0, 0, 0]}]}} />
          ...
          style={{
            transform: [
              //everywher we have provided x=rcos,y=rsin
              //to rotate planet around sun
              {translate: [70*Math.cos(this.state.angle1), 0 , 60*Math.sin(this.state.angle1)]},
              
              {scale: [0.8, 0.8, 0.8]},
              //to rotate about it'sown axis
              {rotateY: this.state.rotation}
            ]
          }}
         />
